    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor="var(--accent, #ECB365)" />
              <stop offset="25%" stopColor="#ffffff" />
              <stop offset="50%" stopColor="var(--accent, #ECB365)" />
              <stop offset="75%" stopColor="#ffffff" />
              <stop offset="100%" stopColor="var(--accent, #ECB365)" />
            </>
          )}
        </linearGradient>
      ...
      >
        {text}<tspan className="fill-transparent stroke-[var(--accent)]">.</tspan>
      </motion.text>
      <text
        x="50%"
        y="50%"
...
export const FooterBackgroundGradient = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(125% 125% at 50% 10%, transparent 50%, rgba(236, 179, 101, 0.05) 100%)",
      }}
    />
  );
};
